...
public class SessionController extends JSFController {
	...
	private UserTypes adminUserType = UserTypes.ADMINISTRATOR;
	
	public UserTypes getAdminUserType(){
	...
	public String login() {
		try {
			...
			logger.log(Level.FINEST, "User attempting login with email \"{0}\"...", userName);
			...
			default:
				...
				logger.log(Level.INFO, "System failure during login. Email: \"" + userName + "\"; reason: \"" + e.getReason() + "\"", e);
	...
	public String register() {
		return "/core/register/index.xhtml?faces-redirect=true";
	}
}
